...
export const FORGOT_USER_NAME = 'For login related issues please get in touch with Aliera Member Services at (844) 834-3456 or';
...
export const ContactUs = '<div class="contactText"><span style="color:#034C7B;"><b>Phone number:</b></span><br/>(844) 412-3019 <br/>' +
  '<span style="color:#034C7B;" > <b>Email: </b></span > <br/>info@alierahealthcare.com<br/ > </div>';
...
// external mail id's
export const ALIERA_MAIL = 'info@alierahealth.com';
// icons names
...
export const THANK_YOU_CONTACT = 'Thanks for getting in touch with Aliera';
...
export const fbLink = 'https://www.facebook.com/pages/category/Consulting-Agency/Aliera-Healthcare-183629259063477/';
export const linkdenLink = 'https://www.linkedin.com/company/aliera-healthcare-inc-';
...
export const TERMS_CONDITIONS = '<div><h3>Aliera Healthcare Plan Disclosures</h3><p>This is not a contract. This is a voluntary program offered by Aliera Healthcare, in relationship with a HealthCare Sharing Ministry (HCSM) program offered within certain plans. Your membership is with Aliera and cannot be transferred to anyone else. Only you and your enrolled dependents are eligible under the membership.</p><p>All Aliera members utilizing any Health Care Sharing Ministry services are required to declare their acknowledgment of the Statement of Beliefs and make an attestation that they are of like mind with the ministry beliefs.</p></div>' +
  ...
  '<div><h4>DISCLAIMER</h4><p>THE MINISTRY IS NOT AN INSURANCE COMPANY AND THE MINISTRY DOES NOT OFFER ANY INSURANCE PRODUCTS OR POLICIES. THE MINISTRY DOES NOT ASSUME ANY RISK FOR YOUR MEDICAL EXPENSES, AND THE MINISTRY MAKES NO PROMISE TO PAY. HEALTH CARE SHARING MINISTRIES ARE NOT GOVERNED BY INSURANCE LAWS.</p><p>THE HEALTH CARE SHARING MINISTRY OFFERS VOLUNTARY PARTICIPATION IN ITS HEALTH CARE SHARING MINISTRY. MINISTRY SERVICES ARE ADMINISTERED BY ALIERA HEALTHCARE, INC.</p></div>' +
  ...
  '<div><h4>Health Care Sharing Disclosures</h4><h5>Promise to Pay</h5><p>The ministry does not make a promise to pay or any guarantee of payment of your medical expenses. You will be responsible for the payment of your medical bills. The ministry does not assume your risk. The ministry does not guarantee that your medical expenses will be shared by other members participating in an Aliera Plan that utilize health care sharing services.</p><h5>Voluntary</h5><p>Participation in the ministry HCSM is voluntary. Enrollment as an Aliera member and participant of the ministry HCSM is voluntary and the sharing of monetary contributions are also voluntary. Enrollment in the ministry sharing plan is not a contract. You are free to cancel your participation at any time. The ministry requests a Monthly Share Amount, to be collected each month you are enrolled, to facilitate the payment of sharing requests published on behalf of other participants</p></div>' +
  ...
  '<p>AlieraCare</p><ul><li>Pre-existing conditions have a 24-month waiting period</li><li>Cancer diagnoses after enrollment have a 12-month continuous membership requirement before sharing is eligible. This means that if you are diagnosed with cancer after you become a member, you are not eligible to request cost sharing of your expenses until you have been an Aliera member for 12 consecutive months.</li><li>There is a maximum limit of $1 million on this Plan</li></ul>' +
  ...
  '<div><h4>Membership Guidelines Details</h4><p>Each Aliera member is responsible for reviewing the HCSM Guidelines provided at the time of enrollment, and to abide by the terms of the Guidelines. It is your responsibility to understand which of your medical expenses are eligible for cost sharing, and which medical expenses are NOT eligible for cost sharing. Members are also provided with a toll-free number to contact Member Services with any questions they have. It is recommended that members call Member Services with any questions regarding eligibility prior to seeking medical services</p></div>' +
  '<div><h4>Authorizations</h4><ul><li>I authorize Aliera Healthcare, Inc. (“Aliera”), on behalf of the ministry, to collect the Monthly Share Amount as a recurring monthly transaction.</li><li>I authorize my first Monthly Share Amount to be processed immediately upon completion of my enrollment.</li><li>I understand that the enrollment fee will be refunded automatically if all individuals on my enrollment form fail to attest to the ministry Statement of Beliefs or if I withdraw my enrollment prior to my membership effective date</li>' +
  '<li>I understand that the enrollment fee will not be refunded if, in the course of enrolling, I fail to respond to written or verbal inquiries from the ministry or Aliera (as the ministry’s administrator) for more than sixty days</li><li>I understand that the ministry offers voluntary participation in the health care sharing ministry, and I understand that Aliera owns and administers memberships on behalf of the ministry.</li><li>I understand both Aliera and the HCSM have the authorization to contact providers to request the release of medical records on behalf of the member.</li></ul></div>' +
